...
values
  ...
  ('ocotillo-golf-club-blue-white', 'Ocotillo Golf Club (Blue/White)', 'Chandler', 'AZ', 'Blue', 69.2, 122, array[3,4,4,3,4,5,3,4,4,4,5,3,4,4,4,3,4,4]::int[], array[5,13,9,11,17,1,15,3,7,11,1,13,9,7,5,17,15,3]::int[]),
