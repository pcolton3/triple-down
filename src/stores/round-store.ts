...
function createDefaultRound(): RoundState {
  ...
  return {
    ...
    gameSettings: {
      ...
      wolfEnabled: false,
      bingoBangoBongoEnabled: false,
      vegasEnabled: false,
      matchPlayEnabled: false,
      teamMatchPlayEnabled: false,
      extraGames: {},
      extraGameUnits: {},
      skinsPot: 0,
      lowNetPot: 0,
      ...
      eaglePot: 0,
      wolfUnit: 0,
      bingoBangoBongoUnit: 0,
      vegasUnit: 0,
      matchPlayUnit: 0,
      teamMatchPlayUnit: 0,
      teamOneName: 'Team 1',
      teamTwoName: 'Team 2',
      ryderCupFormat: 'team_match',
      teamAssignments: {},
      singlesPairings: {},
      courseRating: null,
      slopeRating: null,
          ...
          return {
            ...
            round: {
              ...
              gameSettings: {
                ...
                wolfEnabled: input.gameSettings?.wolfEnabled ?? false,
                bingoBangoBongoEnabled: input.gameSettings?.bingoBangoBongoEnabled ?? false,
                vegasEnabled: input.gameSettings?.vegasEnabled ?? false,
                matchPlayEnabled: input.gameSettings?.matchPlayEnabled ?? false,
                teamMatchPlayEnabled: input.gameSettings?.teamMatchPlayEnabled ?? false,
                extraGames: input.gameSettings?.extraGames ?? {},
                extraGameUnits: input.gameSettings?.extraGameUnits ?? {},
                ...
                wolfUnit: input.gameSettings?.wolfUnit ?? 0,
                bingoBangoBongoUnit: input.gameSettings?.bingoBangoBongoUnit ?? 0,
                vegasUnit: input.gameSettings?.vegasUnit ?? 0,
                matchPlayUnit: input.gameSettings?.matchPlayUnit ?? 0,
                teamMatchPlayUnit: input.gameSettings?.teamMatchPlayUnit ?? 0,
                teamOneName: input.gameSettings?.teamOneName ?? 'Team 1',
                teamTwoName: input.gameSettings?.teamTwoName ?? 'Team 2',
                ryderCupFormat: input.gameSettings?.ryderCupFormat ?? 'team_match',
                teamAssignments: input.gameSettings?.teamAssignments ?? {},
                singlesPairings: input.gameSettings?.singlesPairings ?? {},
                courseRating: input.gameSettings?.courseRating ?? null,
                slopeRating: input.gameSettings?.slopeRating ?? null,
                teeColor: input.gameSettings?.teeColor ?? null,
